...
SCHEMA_PATH = Path('/Users/jakechristensen/snipsummary/api/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/jakechristensen/snipsummary/api/prisma/schema.prisma',
        }
