...
SCHEMA_PATH = Path('/Users/jakechristensen/snipsummary/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/jakechristensen/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    summaryhistory: 'actions.SummaryHistoryActions[models.SummaryHistory]'
    ...
    def __init__(
        ...
        *,
        ...
        self.summaryhistory = actions.SummaryHistoryActions[models.SummaryHistory](self, models.SummaryHistory)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/jakechristensen/snipsummary/prisma/schema.prisma',
        }
...
class Batch:
    ...
    summaryhistory: 'SummaryHistoryBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.summaryhistory = SummaryHistoryBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class SummaryHistoryBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
