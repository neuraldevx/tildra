...
class BaseSummaryHistory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['SummaryHistory']] = 'SummaryHistory'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SummaryHistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.SummaryHistoryActions[_PrismaModelT](client or get_client(), cls)
